...
test -f /var/tmp/ds4v_model.py || { echo "ds4v_model.py MISSING at /var/tmp" >&2; exit 4; }
test -f /var/tmp/ds4v_vision.py || { echo "ds4v_vision.py MISSING at /var/tmp" >&2; exit 4; }
test -f /var/tmp/ds4v_mm.py || { echo "ds4v_mm.py MISSING at /var/tmp" >&2; exit 4; }
test -f /var/tmp/ds4v_registry.py || { echo "ds4v_registry.py MISSING at /var/tmp" >&2; exit 4; }
